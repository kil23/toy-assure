...
@RestController
public class GetServerFileRestController {

    private static final Logger logger = Logger.getLogger(GetServerFileRestController.class);
    private static final String PDF_PATH = "src/main/resources/com/assure/";

    @Autowired private ServletContext context;

    @RequestMapping(value = "/api/download/pdf/{fileName}", method = RequestMethod.GET)
